      ...
      <div className="w-1/2 p-4 relative">
        ...
        <ul className="space-y-8">
          {events.map((item, index) => (
            <li key={index} className={`flex ${index % 2 === 1 ? 'justify-start' : 'justify-end'} items-center`}>
      ...
      <div className="w-1/2 p-4 relative">
        ...
        <ul className="space-y-8">
          {volunteeringData.map((item, index) => (
            <li key={index} className={`flex ${index % 2 === 0 ? 'justify-start' : 'justify-end'} items-center`}>
              <div className="w-1/2 px-4">
                <div className="max-w-xs">
                  <Image
                    src={item.photo}
